...
namespace EpicIntegrator
{
    public class ConversionService
    {
        ...
        public string NewPolExtn = "_Feb25";

        public int CreatePolicySQLSwitch = 0;
        public int SDKCreatePolicySwitch = 0;
        public int SDKUpdatePolicySwitch = 0;
        public int SDKReadMCSSwitch = 0;
        public int MCSSQLUpdateSwitch = 0;
        public int SDKUpdatePRBR = 0;
        public int SDKUpdateLine = 0;
        public int SQLUpdateLineSwitch = 0;
        public int SDKPolInfoAppLocation = 0;
        public int SQLPolInfoAppLocation = 0;
        public int SDKOtherLFDet1 = 0;
        public int SDKOtherLFDet2 = 0;
        public int SDKOtherLFDet3 = 0;
        public int LongFormUpdateSwitch = 1;
        public int SQLLongFormUpdate = 0;
        public int ShortFormUpdateSwitch = 0;
        public int SQLShortFormUpdate = 0;
        public int BSCAUpdateSwitch = 0;
        ...
        public List<Tuple<int , int>> GetPolicyList()
        {
            ...
            //{
            //    commandZero.CommandText = "SELECT OldPolID, CFormExists FROM @DBtable where ConversionSuccessful != 1;";
            //    commandZero.Parameters.AddWithValue("@DBtable", DBtable);
        ...
        public Tuple<int, bool> CreatePolicy(int OldPolicyID)
        {
            ...
            if (CreatePolicySQLSwitch == 1)
            {
                ...
                {
                    commandOne.CommandText = "update @DBtable set StartTime = GETDATE() WHERE OldPolID = @OldPolID;";
                    commandOne.Parameters.AddWithValue("@DBtable", DBtable);
            ...
            nPol.Description = NewPolLineDesc(oPol.PolicyTypeCode);
            ...
            if (SDKCreatePolicySwitch == 1)
            {
                int NewPolicyID = EpicSDKClient.Insert_Policy(oMessageHeader, nPol);
            }
            

            var PolicyResult = Tuple.Create<int, bool>(NewPolicyID, MCSExists);

            if (CreatePolicySQLSwitch == 1)
            {
                using (SqlCommand commandTwo = conn.CreateCommand())
                {
                    commandTwo.CommandText = "update @DBtable set NewPolID = @NewPolID, HasMCS = @hasMCS, NewPolLineTypeCode = @NewPolLineTypeCode, NewPolNum = @NewPolNum, NewPolicyInserted = GETDATE() WHERE OldPolID = @OldPolID;";
                    commandTwo.Parameters.AddWithValue("@DBtable", DBtable);
                    commandTwo.Parameters.AddWithValue("@NewPolID", NewPolicyID);
        ...
        public bool UpdatePolicy(int OldPolicyID, int NewPolicyID)
        {
            ...
            using (SqlCommand commandMCS = conn.CreateCommand())
                {
                commandMCS.CommandText = "update @DBtable set HasMCS = @hasMCS, PolicyInfoUpdated= GETDATE() WHERE OldPolID = @OldPolID;";
                commandMCS.Parameters.AddWithValue("@DBtable", DBtable);
        ...
        public void ReadMCS(int OldPolicyID, int NewPolicyID)
        {
            ...
            if (MCSSQLUpdateSwitch == 1)
            {
                ...
                {
                    commandMCSupdate.CommandText = "update @DBtable set MCSUpdated = GETDATE() WHERE OldPolID = @OldPolID;";
                    commandMCSupdate.Parameters.AddWithValue("@DBtable", DBtable);
        ...
        public void UpdateLine(int OldPolicyID, int NewPolicyID)
        {
            ...
            catch (Exception)
            {
                ...
                Console.WriteLine("No Commission Agreement");
            }
            finally
            {
                ...
                if (SQLUpdateLineSwitch == 1)
                {
                    ...
                    {
                        commandUpdateLine.CommandText = "update @DBtable set LineInfoUpdated = GETDATE() WHERE OldPolID = @OldPolID;";
                        commandUpdateLine.Parameters.AddWithValue("@DBtable", DBtable);
        ...
        public void UpdatePolicyInfoApplicatLocation(int OldPolicyID, int NewPolicyID)
        {
            ...
            if (SQLPolInfoAppLocation == 1)
            {
                ...
                {
                    commandAppLoc.CommandText = "update @DBtable set PolAppLocUpdated = GETDATE() WHERE OldPolID = @OldPolID;";
                    commandAppLoc.Parameters.AddWithValue("@DBtable", DBtable);
        ...
        public void LongShortFormUpdate(int oPolId, int nPolId)
        {
            ...
            if (LiabOccurVal.Trim() != "") //Checking if it's a long form
            {
                ...
                // First read all the schedules from the source form = PropLocationCount
                ...
                if (SQLLongFormUpdate == 1)
                {
                    ...
                    {
                        commandLongFormUpdate.CommandText = "update @DBtable set LongFormUpdated = GETDATE() WHERE OldPolID = @OldPolID;";
                        commandLongFormUpdate.Parameters.AddWithValue("@DBtable", DBtable);
